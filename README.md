...
```
{
    ...
    "data": {
        ...
        "links": {
            "first": "http://localhost:86/api/v1/properties?limit=10&page=1",
            "last": "http://localhost:86/api/v1/properties?limit=10&page=1",
            "prev": null,
            "next": null
        },
        "meta": {
            ...
            "links": [
                ...
                {
                    "url": "http://localhost:86/api/v1/properties?limit=10&page=1",
                    "label": "1",
                    "active": true
                },
                {
            ...
            "path": "http://localhost:86/api/v1/properties",
            "per_page": 15,
            "to": 1,
            "total": 1
        }
